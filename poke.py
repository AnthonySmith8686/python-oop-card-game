# create pokemon
# objects are uppercase. so Pokemon
# dundar methods are the __ methods
# self is the reference to the current instance the is being created. for everyone one, it's itself.
class Pokemon:
